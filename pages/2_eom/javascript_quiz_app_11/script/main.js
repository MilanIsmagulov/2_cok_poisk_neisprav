...
let mainQuestions = [
    {
        text: 'Укажите, при каком виде неисправности реверс двигателя не будет осуществлен:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['короткое замыкание', 'изменено подключение проводников', 'некорректные уставки',],
    },
];
