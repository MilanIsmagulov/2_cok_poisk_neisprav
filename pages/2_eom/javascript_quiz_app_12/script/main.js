...
let mainQuestions = [
    {
        text: 'Укажите, в каком случае при нажатии кнопки «ПУСК» включается сигнальная лампа «РЕВЕРС». ',
        right: [0,2],
        type: 3,
        points: 100,
        answers: ['перепутанные провода на магнитных пускателях «КМ1» и «КМ2»', 'установлена перемычка между магнитными пускателями', 'перепутанные провода на лампах «ВПЕРЕД» и «РЕВЕРС»','обрыв провода на лампе «ВПЕРЕД»'],
    },
];
