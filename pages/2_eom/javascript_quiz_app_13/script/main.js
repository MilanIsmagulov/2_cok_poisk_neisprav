...
let mainQuestions = [
    {
        text: 'Укажите, в каком случае при нажатии кнопки «ПРОВЕРКА ЛАМП» световая индикация не осуществляется, индикация только на лампах «ГОТОВ» и «АВАРИЯ»:',
        right: [0],
        type: 1,
        points: 100,
        answers: ['нажата кнопка АВАРИЯ', 'шкаф обесточен', 'неисправность цепи управления',],
    },
];
