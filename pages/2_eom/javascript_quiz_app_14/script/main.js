...
let mainQuestions = [
    {
        text: 'Укажите, в каком случае при нажатии кнопки «ПУСК» на стенде включается одновременно индикаторная лампа «СТУПЕНЬ1»,  «СТУПЕНЬ2»:',
        right: [0,1],
        type: 3,
        points: 100,
        answers: ['некорректные уставки реле', 'перемычка в клеммнике Х2', 'обрыв провода на лампе «СТУПЕНЬ3»', 'перепутаны провода при подключении ламп'],
    },
];
